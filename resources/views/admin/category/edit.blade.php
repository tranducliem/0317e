...
@section('title') Edit "{{ $cate->title }}" Category | PHP0317E @endsection
@section('content')
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Edit "{{ $cate->title }}" Category</h1>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">Edit "{{ $cate->title }}" Category</div>
                    <div class="panel-body">
                        <div class="col-md-6">
                            {!! Form::open(['method' => 'PATCH', 'url' => 'admin/category/' . $cate->id, 'role' => 'form']) !!}
                                <div class="form-group">
                                    <label>Title</label>
                                    <input class="form-control" name="title" placeholder="Title" value="{{ $cate->title }}">
                                </div>
                                <div class="form-group">
                                    <label>Status</label>
