...
@section('content')
        ...
        <div class="container">
            <div class="callbacks_container">
                <ul class="rslides" id="slider">
                    <li><img src="{{ asset('img/slider1.jpg') }}" class="img-responsive" alt=""/></li>
                    <li><img src="{{ asset('img/2.jpg') }}" class="img-responsive" alt=""/></li>
                    <li><img src="{{ asset('img/3.jpg') }}" class="img-responsive" alt=""/></li>
                </ul>
            </div>
        </div>
    </div>
                ...
                @if(isset($products))
                    @foreach($products as $item)
                        <div class="col-md-3 span_6">
                            <div class="box_inner">
                                <img src="{{ asset('uploads/product/'.$item->thumbnail) }}" class="img-responsive"
                                     alt="{{ $item->title }}"/>
                                ...
                                <div class="desc">
                                    ...
                                    <ul class="list2">
                                        <li class="list2_left">
                                            <span class="m_1">
                                                <a href="{{ url('cart/add/'.$item->id) }}" class="link">Add to Cart</a>
                                            </span>
                                        </li>
                                        <li class="list2_right">
                                            <span class="m_2">
                                                <a href="{{ url('product/show/'.$item->id) }}" class="link1">See More</a>
                                            </span>
                                        </li>
                                        <div class="clearfix"></div>
                                    </ul>
    ...
    <div class="content_middle">
        <div class="container">
            ...
            <ul id="flexiselDemo3">
                <li><img src="{{ asset('img/n1.jpg') }}" class="img-responsive"/>
                    <div class="grid-flex"><h4>Contrary to popular </h4>
                        <p>589,90 $</p>
                        <div class="m_3"><a href="#" class="link2">Add to Cart</a></div>
                        <div class="ticket"></div>
                    </div>
                </li>
                <li><img src="{{ asset('img/n2.jpg') }}" class="img-responsive"/>
                    <div class="grid-flex"><h4>Contrary to popular </h4>
                        <p>589,90 $</p>
                        <div class="m_3"><a href="#" class="link2">Add to Cart</a></div>
                        <div class="ticket"></div>
                ...
                <li><img src="{{ asset('img/n3.jpg') }}" class="img-responsive"/>
                    <div class="grid-flex"><h4>Contrary to popular </h4>
                        <p>589,90 $</p>
                        <div class="m_3"><a href="#" class="link2">Add to Cart</a></div>
                        <div class="ticket"></div>
                ...
                <li><img src="{{ asset('img/n4.jpg') }}" class="img-responsive"/>
                    <div class="grid-flex"><h4>Contrary to popular </h4>
                        <p>589,90 $</p>
                        <div class="m_3"><a href="#" class="link2">Add to Cart</a></div>
                        <div class="ticket"></div>
                ...
                <li><img src="{{ asset('img/n5.jpg') }}" class="img-responsive"/>
                    <div class="grid-flex"><h4>Contrary to popular </h4>
                        <p>589,90 $</p>
                        <div class="m_3"><a href="#" class="link2">Add to Cart</a></div>
                        <div class="ticket"></div>
    ...
    <div class="container">
        <div class="content_middle_bottom">
            ...
            <div class="col-md-8">
                ...
                <div class="a-top">
                    <div class="left-grid">
                        <img src="{{ asset('img/t4.jpg') }}" class="img-responsive" alt=""/>
                    </div>
                ...
                <div class="a-top">
                    <div class="left-grid">
                        <img src="{{ asset('img/t5.jpg') }}" class="img-responsive" alt=""/>
                    </div>
                    <div class="right-grid">
                        <h4><a href="#">Duis autem vel eum iriure dolor in hendrerit</a></h4>
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod
                ...
                <div class="a-top">
                    <div class="left-grid">
                        <img src="{{ asset('img/t6.jpg') }}" class="img-responsive" alt=""/>
                    </div>
                    <div class="right-grid">
                        <h4><a href="#">Duis autem vel eum iriure dolor in hendrerit</a></h4>
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod
                ...
                <div class="a-top">
                    <div class="left-grid">
                        <img src="{{ asset('img/t7.jpg') }}" class="img-responsive" alt=""/>
                    </div>
                    <div class="right-grid">
                        <h4><a href="#">Duis autem vel eum iriure dolor in hendrerit</a></h4>
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod
        ...
        <div class="content_bottom">
            <div class="col-md-3 span_1">
                ...
                <img src="{{ asset('img/t8.jpg') }}" class="img-responsive" alt=""/>
            </div>
            <div class="col-md-3 span_1">
                <ul class="spinner">
                    <i class="bubble"> </i>
